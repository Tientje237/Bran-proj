...
const stopwatchvalueinput = document.getElementById("stopwatchvalue");
// stopwatchvalue.value = stopwatchResult.value;
...
function updateTimer() {
  ...
  stopwatchvalueinput.value = stopwatchvalue.value;
}
